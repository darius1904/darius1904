...
🎓 I am a **3th year Computer Science student at the Polytechnic University of Timișoara**, with international experience through exchange semesters at the University of Stuttgart (Germany) and the University of Bremen (Germany). 
...
- Benchmarked physics synchronization for simulation robustness  
...
- Verified functionality across full instruction benchmarks  
...
- Designed propulsion and sensor housing components  

---

### 🌦️ Command-Line Weather App
**Tech:** Python  
- CLI tool for real-time weather data using OpenWeatherMap API  
...
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=darius1904&layout=compact&theme=tokyonight)
